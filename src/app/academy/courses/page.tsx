  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600">Изучайте новые технологии и развивайте профессиональные навыки</p>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">Получены сертификаты</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">Средний по всем курсам</p>
              </CardContent>
            </Card>
          </div>
              ...
              <Card key={course.id} className="hover:shadow-lg transition-shadow">
                <CardHeader className="pb-3">
                  ...
                  <div className="flex items-center justify-between">
                    <Badge variant={course.status === "Завершен" ? "default" : "secondary"}>{course.status}</Badge>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1">
              <div className="relative">
                ...
                <Input placeholder="Поиск курсов..." className="pl-10" />
              </div>
            </div>
            <div className="flex gap-2">
              <Select>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="engines">Двигатели</SelectItem>
                  <SelectItem value="body">Кузовные работы</SelectItem>
                  <SelectItem value="management">Менеджмент</SelectItem>
                  <SelectItem value="brakes">Тормозные системы</SelectItem>
