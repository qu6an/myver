        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <div>
                <h4 className="mb-2 font-medium">Что вы изучите:</h4>
              ...
              <Separator />
              <div>
                <h4 className="mb-2 font-medium">Требования:</h4>
                <ul className="space-y-1">
        ...
        <TabsContent value="lessons">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                {lessons.length} уроков • {course.duration} общая
                продолжительность
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="reviews">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Средняя оценка: {course.rating} из 5 ({course.students} отзывов)
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
