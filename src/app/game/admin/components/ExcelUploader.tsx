...
export const ExcelUploader = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      setUploadResult({
        ...
        errors: [...validationResults.errors, ...uploadResultData.errors],
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div>
              ...
              <ul className="text-muted-foreground space-y-1 text-sm">
                <li>
                  A: ID (оставьте пустым для новых вопросов, укажите ID для
                ...
                <li>I: Категория</li>
                <li>
                  J: Сложность (EASY, LITE, LITE2, NORMAL, HARD, HARD2, TEST
                  (для вопросов тестовой игры))
                </li>
              </ul>
            </div>
          </div>
      ...
      <Card className="game-card p-6">
        <div className="space-y-4">
          <h3 className="text-lg font-semibold text-white">Загрузка файла</h3>
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-center">
                ...
                >
                  ...
                  {isUploading ? 'Загрузка...' : 'Загрузить вопросы'}
                </Button>
              </div>
            </div>
          ) : (
            <div className="space-y-4">
              <h4 className="font-medium text-white">Результат загрузки</h4>
