...
export const MigrationManager = () => {
    ...
    try {
      ...
      if (data.success) {
        setMigrationLogs(prev => [
          ...
          `Примерное количество записей: ${JSON.stringify(data.estimatedRows, null, 2)}`,
        ]);
  ...
  const startMigration = async () => {
    ...
    try {
      setMigrationLogs(prev => [...prev, 'Начинается миграция данных...']);
  ...
  const validateMigration = async () => {
    ...
    try {
      setMigrationLogs(prev => [...prev, 'Начинается валидация миграции...']);
  ...
  return (
    <div className="space-y-6">
      ...
      {migrationResult && (
        <Alert
          className={
            migrationResult.success ? 'border-green-500' : 'border-red-500'
          }
        >
        ...
        <Card className="game-card p-4">
          <div className="space-y-2">
            <div className="flex justify-between text-sm">
              <span className="text-white">Прогресс миграции</span>
              <span className="text-game-secondary">{migrationProgress}%</span>
            </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={e =>
                    setConfig({
                      ...config,
                      sourceDb: { ...config.sourceDb, host: e.target.value },
                    })
                  }
        ...
        <TabsContent value="migration" className="mt-6">
          <div className="space-y-6">
            <Alert>
              ...
              <AlertDescription>
                Убедитесь, что вы создали резервную копию данных и проверили
                ...
                <div className="mt-6">
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      ...
                      >
                        {migrationResult.success ? 'Успешно' : 'Ошибка'}
                      </Badge>
                    </div>
            ...
            {validationResults ? (
              <div className="space-y-4">
                <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                  ...
                  <div className="text-center">
                    <div
                      className={`text-2xl font-bold ${validationResults.success ? 'text-green-400' : 'text-red-400'}`}
                    >
                ...
                {validationResults.tables && (
                  <div className="mt-6">
                    ...
                    <div className="space-y-2">
                      {Object.entries(validationResults.tables).map(
                        ([tableName, details]: [string, any]) => (
                          ...
                          >
                            ...
                            <div className="flex items-center space-x-2">
                              ...
                              >
                                {details.status === 'success' ? 'OK' : 'Ошибка'}
                              </Badge>
                            </div>
                          </div>
                        )
