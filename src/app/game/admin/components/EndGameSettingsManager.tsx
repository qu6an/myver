    ...
    try {
      ...
      if (data) {
        setSettings({
          ...
          description: data.description || 'Спасибо за участие в EVERYCAR!',
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center space-x-3">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Настройте сообщения, которые видят игроки после завершения игры
          </p>
        </div>
      </div>
      ...
      <Card className="game-card p-6">
        <div className="space-y-6">
          ...
          {/* Additional Text */}
          <div className="space-y-2">
            <Label className="text-white">Дополнительный текст</Label>
            <Textarea
              value={settings.text}
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={e => handleInputChange('text_link', e.target.value)}
        ...
        <div className="space-y-4">
          ...
          <div className="bg-muted/20 border-border rounded-lg border p-4">
            <div className="space-y-3 text-center">
              <h4 className="text-xl font-bold text-white">{settings.title}</h4>
              ...
              {settings.text && (
                <div className="bg-game-primary/10 border-game-primary/30 mt-4 rounded-lg border p-3">
                  <p className="text-sm text-white">{settings.text}</p>
                </div>
              )}

              <Button className="game-button-primary mt-4 text-white" disabled>
                {settings.text_link}
              </Button>
            </div>
          </div>
