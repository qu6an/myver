...
const GameRules = ({ settings }: GameRulesProps) => {
  return (
    <Card className="game-card p-6">
      <h3 className="text-foreground mb-4 text-2xl font-bold">Правила игры</h3>
        ...
        <div className="space-y-3">
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-sm">Разной сложности из базы 200+ вопросов</p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            ...
            <div>
              <p className="text-foreground font-medium">
                {settings.timePerQuestion / 1000} секунд на ответ
              </p>
              <p className="text-sm">Каждая миллисекунда = 1 очко</p>
            </div>
          </div>
        </div>
        <div className="space-y-3">
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              <p className="text-foreground font-medium">Еженедельные призы</p>
              <p className="text-sm">20 призеров каждое воскресенье</p>
            </div>
          </div>
        </div>
      </div>
