  ...
  const tasks = [
    {
      ...
      description: "Тест 3 доступен до 10 марта, не упустите шанс набрать баллы",
    ...
    },
    {
      ...
      description: "Повысьте квалификацию и получите сертификат от производителя",
    ...
    },
    {
      ...
      description: "Диагностика электронных систем современных автомобилей",
              ...
              >
                <div className="flex items-start justify-between">
                  <div className="flex items-start gap-3 flex-1">
                    <div className={`p-1.5 rounded-full ${statusConfig.bg} border ${statusConfig.border}`}>
                      <IconComponent className={`h-4 w-4 ${statusConfig.text}`} />
                    </div>
                    <div className="flex-1">
                      <h4 className={`font-semibold ${statusConfig.text}`}>
                        {task.title}
                      </h4>
                      <p className="text-sm text-gray-600 mt-1">
                        {task.description}
                  ...
                  <Button 
                    ...
                    className="ml-2"
                  >
                    {task.status === "completed" ? "Завершено" : "Начать"}
                  </Button>
                </div>
              </div>
            );
