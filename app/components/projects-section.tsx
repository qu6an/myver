...
const projects = [
  {
    ...
    description:
      "Соревнуйтесь в знаниях автомобилей, набирайте очки за скорость и правильные ответы. Побеждайте в еженедельных розыгрышах и получайте реальные призы в виде баллов (1 балл = 1 рубль).",
  ...
  },
  {
    ...
    title: "EVERYCAR",
    description:
      "Крупнейшая партнерская программа автосервисов по всей России. Увеличьте продажи, мотивируйте команду и повысьте конкурентоспособность вашего автосервиса.",
  ...
  },
  {
    ...
    description:
      "Крупнейшее ежегодное профессиональное соревнование, проводимое среди станций постгарантийного обслуживания и ремонта легковых автомобилей, а также малого коммерческого транспорта.",
  ...
  {
    icon: Award,
    title: "Аттестация производителем",
    description:
      "Получите официальную аттестацию от ведущих производителей автокомпонентов. Повысьте статус вашего автосервиса и доверие клиентов.",
  ...
  },
  {
    ...
    title: "Академия СТО",
    description:
      "Развивайте персонал через практическое обучение управлению и продажам. Получайте готовые инструменты для оптимизации бизнес-процессов и увеличения прибыли вашего автосервиса.",
    linkText: "Узнать больше",
    badge: { text: "Доступно", variant: "active" as const },
  },
  {
    ...
    title: "MyTeam",
    description:
      "Партнерская программа с услугами колл-центра для СТО. NPS-опросы, фантом-звонки и информирование клиентов о предложениях. Повышаем лояльность и прибыль.",
    linkText: "Узнать больше",
    badge: { text: "Доступно", variant: "active" as const },
  },
]
