...
export const metadata: Metadata = {
	...
	keywords:
		"автосервис, автоком, everycar, геймификация, управление сто, аналитика автосервиса",
	openGraph: {
		title: "АВТОКОМ — Управление автосервисом",
		description:
			"Платформа управления автосервисом с геймификацией и аналитикой",
		type: "website",
	},
	generator: "v0.app",
};
...
export default function RootLayout({
	...
	return (
		<html lang='ru' className='scroll-smooth'>
			...
			<body
				className={`${inter.variable} font-sans antialiased bg-[#e9ecf2] text-gray-900`}
			>
				{children}
				{/* <Analytics /> */}
			</body>
