					...
					<>
						<DialogHeader className='space-y-4 text-center'>
							...
							<p className='text-gray-400'>
								Вы ответили на {totalQuestions} пробных
								вопросов. Чтобы играть и сохранять свой
								результат, пожалуйста, войдите или
								зарегистрируйтесь.
							</p>
						</DialogHeader>
					...
					<>
						<DialogHeader className='space-y-4 text-center'>
							...
							<p className='text-center text-gray-400'>
								{endGameInfo?.description ||
									"Спасибо за участие в EVERYCAR!"}
							</p>
						</DialogHeader>
