					...
					<div className='flex items-center justify-between'>
						<div>
							<Label className='text-base'>
								Включить еженедельный конкурс
							</Label>
							<p className='text-muted-foreground text-sm'>
								Автоматическое определение призеров каждую
								неделю
							</p>
						</div>
						<Switch
				...
				<div className='space-y-6'>
					<div className='flex items-center justify-between'>
						<div>
							...
							<p className='text-muted-foreground text-sm'>
								Временно отключить доступ к игре для всех
								пользователей
							</p>
						</div>
						<Switch
			...
			{hasChanges && (
				<div className='text-center'>
					<p className='flex items-center justify-center text-sm text-yellow-400'>
						<Bell className='mr-1 h-4 w-4' />У вас есть
