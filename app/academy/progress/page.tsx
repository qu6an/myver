		...
		<div className='space-y-6'>
			...
			<div>
				...
				<p className='text-gray-600'>
					Отслеживайте свои достижения и развитие навыков
				</p>
			</div>
				...
				<Card>
					...
					<CardContent>
						...
						<p className='text-xs text-muted-foreground'>
							из {userStats.totalCourses} всего
						</p>
					</CardContent>
				</Card>
				...
				<Card>
					...
					<CardContent>
						...
						<p className='text-xs text-muted-foreground'>
							...
							{userStats.nextLevelPoints - userStats.totalPoints}
						</p>
					</CardContent>
				</Card>
				...
				<div className='lg:col-span-2 space-y-6'>
								...
								<div className='flex items-center justify-between'>
									<div>
										<p className='font-semibold'>
											Текущий уровень: {userStats.level}
										</p>
										<p className='text-sm text-gray-600'>
											Следующий уровень: Мастер
										</p>
									</div>
					...
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Ваш прогресс по различным направлениям
							</CardDescription>
						</CardHeader>
						<CardContent>
							<div className='space-y-4'>
