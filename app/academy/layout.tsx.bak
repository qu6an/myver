        ...
        <Sidebar>
          <SidebarHeader>
            <div className="flex items-center space-x-3 px-2">
              ...
              <div>
                <h2 className="text-lg font-bold text-gray-900">Академия</h2>
                <p className="text-xs text-gray-500">EVERYCAR</p>
              </div>
            </div>
          </SidebarHeader>
            ...
            <div className="flex items-center justify-between h-16 px-4">
              <div className="flex items-center space-x-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h1 className="text-lg font-bold text-gray-900">EVERYCAR</h1>
                    <p className="text-xs text-gray-500">Онлайн Академия</p>
                  </div>
                </div>
              </div>
              <div className="flex items-center space-x-4">
